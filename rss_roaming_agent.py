...
class RssRoamingAgent(BasicControl):
    ...
    def __init__(self, actor, args=None):
        super(RssRoamingAgent, self).__init__(actor)
        ...
        self._restrictor_enabled = False
        ...
        self._agent_behavior._proximity_vehicle_threshold = 0.05  # meters
